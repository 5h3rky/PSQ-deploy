...
form.addEventListener('submit', function (e) {
  ...
  const consentField = document.getElementById('f-consent').closest('.field');

  [propertyField, nameField, phoneField, emailField, consentField].forEach(f => f.classList.remove('invalid'));
  ...
  if (!consent) { consentField.classList.add('invalid'); valid = false; }
  ...
  if (!botcheck.checked) {
    fetch('https://api.web3forms.com/submit', {
      ...
      body: JSON.stringify({
        ...
        email,
        message,
        consent: 'Yes — PDPA consent given at ' + new Date().toISOString(),
        consent_text: 'I consent to Zeon Properties collecting and processing my personal data in order to contact me about this development.',
